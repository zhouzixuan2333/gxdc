...
# Configuration
SEQ_LEN = 96  # Past 96 hours
SHORT_TERM_PRED = 96  # Predict next 96 hours
LONG_TERM_PRED = 240  # Predict next 240 hours
BATCH_SIZE = 32
EPOCHS = 2
LEARNING_RATE = 0.001
...
def main(train_path, test_path, seq_len, pred_len):
    ...
    for i in range(5):  
        model = TransformerModel(input_dim=train_sequences.shape[2], pred_len=pred_len)
    ...
    plot_prediction(
        ...
        save_path='/data/hhb/project1/work/casual' + str(pred_len) + '.png'
    )
    ...
    plot_prediction(
        ...
        title='Compare pred and GT',
        save_path='/data/hhb/project1/work/registered' + str(pred_len) + '.png'
    )
    ...
    plot_prediction(
        ...
        title='Compare pred and GT',
        save_path='/data/hhb/project1/work/cnt' + str(pred_len) + '.png'
    )
...
main('/data/hhb/project1/work/train_data.csv', '/data/hhb/project1/work/test_data.csv', SEQ_LEN, SHORT_TERM_PRED)

main('/data/hhb/project1/work/train_data.csv', '/data/hhb/project1/work/test_data.csv', SEQ_LEN, LONG_TERM_PRED)
